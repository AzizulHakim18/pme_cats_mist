    ...
    return (
        <section class="flex flex-col md:flex-row h-screen items-center">
            ...
            <div class="bg-blue-600 hidden lg:block w-full md:w-1/2 xl:w-2/3 h-screen">
                {/* <img src="https://img.freepik.com/free-vector/web-development-programmer-engineering-coding-website-augmented-reality-interface-screens-developer-project-engineer-programming-software-application-design-cartoon-illustration_107791-3863.jpg?size=626&ext=jpg&ga=GA1.2.516224105.1653748033"
                ...
                <div class="w-full h-100">
                  ...
                  focus:bg-white focus:outline-none" required />
                        ...
                        <div class="text-right mt-2">
                            <Link class="text-sm font-semibold text-gray-700 hover:text-blue-700 focus:text-blue-700">Forgot Password?</Link>
                        </div>
